    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".main-page__slider")) new core(".main-page__slider", {
                ...
                on: {
                    init: function() {
                        const navigate = document.querySelectorAll(".main-page__navigate .swiper-pagination-bullet");
                        navigate.forEach(((el, index) => {
                            let num = index < 10 ? "0" : "";
            ...
            if (document.querySelector(".gallery-page__slider")) {
                let gallerySlider = new core(".gallery-page__slider", {
                    modules: [ Lazy ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: "auto",
                ...
                function gallerySliderFix() {
                    const galleryContainer = document.querySelector(".gallery-page__container");
                    const diff = (window.innerWidth - galleryContainer.offsetWidth) / 2;
                    if (diff > 0) document.querySelector(".gallery-page__slider").style.width = document.querySelector(".gallery-page__slider").offsetWidth + diff + 15 + "px"; else document.querySelector(".gallery-page__slider").style.width = document.querySelector(".gallery-page__slider").offsetWidth + 15 + "px";
                }
                window.addEventListener("resize", gallerySliderFix);
                gallerySliderFix();
                gallerySlider.update();
            }
            if (document.querySelector(".main-bar__slider")) new core(".main-bar__slider", {
                ...
                on: {
                    ...
                    init: function() {
                        const navigateB = document.querySelectorAll(".main-bar__navigate .swiper-pagination-bullet");
                        navigateB.forEach(((el, index) => {
                            let num = index < 10 ? "0" : "";
                            el.innerHTML = `${num}${index + 1}`;
                        }));
                    }
            ...
            if (document.querySelector(".menu-page__slider")) new core(".menu-page__slider", {
            ...
            if (document.querySelector(".hours-page__slider")) new core(".hours-page__slider", {
                modules: [ EffectFade, Lazy, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".main-services__slider")) new core(".main-services__slider", {
                modules: [ EffectFade, Lazy, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        function headerScroll() {
            ...
            document.addEventListener("windowScroll", (function(e) {
                ...
                header.classList.contains("_header-show") ? header.classList.remove("_header-scroll") : null;
            }));
        }
        setTimeout((() => {
        ...
        da.init();
        if (document.querySelector(".video-page")) document.addEventListener("watcherCallback", (function(e) {
            const entry = e.detail.entry;
            const targetElement = entry.target;
            if ("video" === targetElement.dataset.watch) if (entry.isIntersecting) {
                const time = targetElement.querySelector("video");
                time.play();
            } else targetElement.querySelector("video").pause();
        }));
        if (document.querySelector(".video-page")) document.querySelector(".video-page").addEventListener("click", (function(e) {
            if (!document.querySelector(".video-page").classList.contains("_init")) {
                document.querySelector(".video-page").querySelector("video").src = document.querySelector(".video-page").querySelector("video").dataset.full;
                document.querySelector(".video-page").classList.add("_active");
                document.querySelector(".video-page").classList.add("_init");
                document.querySelector(".video-page").querySelector("video").play();
                document.querySelector(".video-page").querySelector("video").muted = false;
            } else {
                document.querySelector(".video-page").querySelector("video").pause();
                document.querySelector(".video-page").classList.toggle("_active");
            }
        }));
        window["FLS"] = true;
        isWebp();
