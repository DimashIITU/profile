(() => {
    ...
    function formQuantity() {
        document.addEventListener("click", (function(e) {
            ...
            let sum = document.querySelector(".change-value");
            if (targetElement.closest(".quantity__math")) {
                let inp = targetElement.closest(".quantity").querySelector("input");
                let value = parseInt(inp.value);
                if (targetElement.classList.contains("quantity__math_plus")) {
                    value++;
                    sum.innerHTML = Math.floor(Number(sum.innerHTML) + 17.5);
                    if (value > inp.max) value = 9;
                } else {
                    --value;
                    if (value < 1) value = 1;
                    sum.innerHTML = Math.floor(Number(sum.innerHTML) - 17.5);
    ...
    function initSliders() {
        if (document.querySelector(".header__slider")) {
            const thumbsSwiper = new core(".header-bottom__slider", {
                ...
                speed: 800,
                navigation: {
                    prevEl: ".slide-header__arr-left",
                    nextEl: ".slide-header__arr-right"
                },
                on: {}
            });
        ...
        if (document.querySelector(".surf-page__slider")) {
            const thumbsSurfSwiper = new core(".map-serf__slider", {
                modules: [ Thumb ],
                observer: true,
                observeParents: true,
                slidesPerView: 7,
            ...
            new core(".surf-page__slider", {
                ...
                speed: 800,
                thumbs: {
                    swiper: thumbsSurfSwiper
                },
                centeredSlides: true,
                navigation: {
                    prevEl: ".surf-page__arr-left",
                    nextEl: ".surf-page__arr-right"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
        ...
        if (document.querySelector(".travel-page__slider")) new core(".travel-page__slider", {
        ...
        if (document.querySelector(".sleep-page__slider")) new core(".sleep-page__slider", {
            modules: [ Navigation, EffectFade, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".shop-page__slider")) new core(".shop-page__slider", {
            modules: [ Navigation, EffectFade, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    da.init();
    let media = document.querySelector(".travel-page__container_a");
    if (window.innerWidth <= 768) {
        delete media.dataset.watch;
        media.classList.add("op");
    }
    window["FLS"] = true;
    isWebp();
    addTouchClass();
