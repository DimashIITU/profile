(() => {
    ...
    function initSliders() {
        if (document.querySelector(".gallery-page__slider")) new core(".gallery-page__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
    ...
    da.init();
    let left = document.querySelector(".main-page__content");
    let right = document.querySelector(".main-page__img-ibg");
    window.addEventListener("load", (() => {
        left.classList.add("_watcher-view");
        right.classList.add("_watcher-view");
    }));
    let reviews = document.querySelector(".reviews-page");
    if (window.innerWidth <= 400) delete reviews.dataset.watch;
    window["FLS"] = true;
    isWebp();
    menuInit();
    spollers();
